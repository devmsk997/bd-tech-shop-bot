        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if response.status_code in [503, 429]:
                    ...
                    print(f"⏳ Rate limited or busy. Waiting {delay} seconds before retrying...")
                    time.sleep(delay)
                else:
                    break
